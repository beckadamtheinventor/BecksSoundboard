...
//----------------------------------------------------------------------------------
// Initialize audio device by device ID
void InitAudioDeviceByID(ma_device_id* deviceid)
{
    // Init audio context
    ...
    config.playback.pDeviceID = deviceid;  // NULL for the default playback AUDIO.System.device.
...
void InitAudioDevice() {
    InitAudioDeviceByID(NULL);
    ma_device_info** playbackDevices;
    ma_uint32 *deviceCount;
    ma_device_info** captureDevices;
    ma_result res = ma_context_get_devices(&AUDIO.System.context,
        &AUDIO.System.playbackDevices,
        &AUDIO.System.playbackDeviceCount,
        &AUDIO.System.captureDevices,
        &AUDIO.System.captureDeviceCount);
}

// Return pointer to list of playback devices
ma_device_info* GetPlaybackDevices(ma_uint32* count) {
    *count = AUDIO.System.playbackDeviceCount;
    return AUDIO.System.playbackDevices;
}

// Return pointer to list of capture devices
ma_device_info* GetCaptureDevices(ma_uint32* count) {
    *count = AUDIO.System.captureDeviceCount;
    return AUDIO.System.captureDevices;
}
